...
export default function RadarMapPanel({ current, currentCity, darkMode = true }) {
  const canvasRef = useRef(null);
  const [isPlaying, setIsPlaying] = useState(true);
  const [activeLayer, setActiveLayer] = useState("rain"); // "rain" | "wind" | "thermal"
  const [rangeKm, setRangeKm] = useState(100); // 50, 100, 250
