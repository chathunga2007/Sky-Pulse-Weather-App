...
import { Clock, Thermometer, Droplets, Wind, type LucideIcon } from "lucide-react";
import WeatherIcon from "./WeatherIcon";
import type { ChartTab, TempUnit } from "../types/weather";
...
interface ForecastChartProps {
  data: HourlyChartItem[] | null | undefined;
  activeTab: ChartTab;
...
export default function ForecastChart({
  ...
  const CustomTooltip = ({ active, payload }: any) => {
    if (active && payload && payload.length) {
      const p = payload[0].payload as HourlyChartItem;
      return (
