...
import type { AirQualityCurrent, AqiStatus, WeatherCurrent } from "../types/weather";

interface AirQualityPanelProps {
  airQuality: AirQualityCurrent | null;
  aqiInfo: AqiStatus | null;
  current: WeatherCurrent | null;
}

export default function AirQualityPanel({ airQuality, aqiInfo, current }: AirQualityPanelProps) {
