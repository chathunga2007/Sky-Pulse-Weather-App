  ...
  return (
    <div className="lg:col-span-3 space-y-4">
      <div className="flex items-center justify-between px-1">
        ...
        <span className="text-xs text-slate-400 font-medium">Real-time Sensor Feeds</span>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
        ...
        <div className="glass-card p-5 sm:p-6 rounded-3xl relative overflow-hidden">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="p-2 rounded-xl bg-sky-500/15 text-sky-400 border border-sky-500/30 icon-glow-blue">
              <Droplets className="w-4 h-4" />
            </div>
          </div>
          <div className="flex items-baseline gap-2">
            <span className="text-4xl font-black text-white">{humidity}</span>
            <span className="text-xl font-light text-cyan-400">%</span>
          </div>
          <div className="mt-4 pt-3 border-t border-slate-800/80 flex items-center justify-between text-xs text-slate-400">
            <span>Dew Point</span>
            <strong className="text-slate-200 font-semibold">{dewPoint}</strong>
          </div>
        </div>
        ...
        <div className="glass-card p-5 sm:p-6 rounded-3xl relative overflow-hidden">
          ...
          <div className="flex items-baseline gap-2">
            <span className="text-4xl font-black text-white">{windSpeed}</span>
            <span className="text-xs font-semibold text-slate-400 uppercase">km/h</span>
            <span className="ml-auto text-xs font-bold px-2 py-0.5 rounded-md bg-cyan-500/10 text-cyan-300 border border-cyan-500/30 flex items-center gap-1">
          ...
          <div className="mt-4 pt-3 border-t border-slate-800/80 flex items-center justify-between text-xs text-slate-400">
            ...
            <strong className="text-slate-200 font-semibold">{windGusts} km/h</strong>
          </div>
        </div>
        ...
        <div className="glass-card p-5 sm:p-6 rounded-3xl relative overflow-hidden">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="p-2 rounded-xl bg-amber-500/15 text-amber-400 border border-amber-500/30 icon-glow-amber">
              <Sun className="w-4 h-4" />
            </div>
          </div>
          <div className="flex items-baseline gap-2">
            <span className="text-4xl font-black text-white">{uvMax}</span>
            <span
              className={`text-xs font-bold px-2 py-0.5 rounded-md border ${
                uvInfo?.bg || "bg-amber-500/20 text-amber-300 border-amber-500/30"
              } ${uvInfo?.color || "text-amber-300"}`}
            >
        ...
        <div className="glass-card p-5 sm:p-6 rounded-3xl relative overflow-hidden">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="p-2 rounded-xl bg-emerald-500/15 text-emerald-400 border border-emerald-500/30 icon-glow-emerald">
              <Eye className="w-4 h-4" />
            </div>
          </div>
          <div className="flex items-baseline gap-2">
            <span className="text-4xl font-black text-white">{visibilityKm}</span>
        ...
        <div className="glass-card p-5 sm:p-6 rounded-3xl relative overflow-hidden">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="p-2 rounded-xl bg-violet-500/15 text-violet-400 border border-violet-500/30 icon-glow-violet">
              <Gauge className="w-4 h-4" />
            </div>
          </div>
          <div className="flex items-baseline gap-2">
            <span className="text-4xl font-black text-white">{pressure}</span>
            <span className="text-xs font-semibold text-slate-400 uppercase">hPa</span>
          </div>
          <div className="mt-4 pt-3 border-t border-slate-800/80 flex items-center justify-between text-xs text-slate-400">
        ...
        <div className="glass-card p-5 sm:p-6 rounded-3xl relative overflow-hidden">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="p-2 rounded-xl bg-rose-500/15 text-rose-400 border border-rose-500/30 icon-glow-rose">
