...
export const getAqiStatus = (aqi?: number | null): AqiStatus => {
  ...
  if (aqi <= 50) {
    return {
      ...
      pct: Math.min(100, (aqi / 50) * 25),
      advice: "Air quality is satisfactory; clean and fresh air.",
    };
  }
  if (aqi <= 100) {
    return {
      ...
      pct: 25 + Math.min(25, ((aqi - 50) / 50) * 25),
      advice: "Acceptable air; sensitive people should take care.",
    };
  }
  if (aqi <= 150) {
    return {
      ...
      pct: 50 + Math.min(25, ((aqi - 100) / 50) * 25),
  ...
  if (aqi <= 200) {
    return {
      ...
      pct: 75 + Math.min(20, ((aqi - 150) / 50) * 20),
      advice: "Everyone may experience slight health effects.",
    };
  }
  return {
    label: "Hazardous",
    ...
    pct: 100,
    advice: "Health warning: Emergency atmospheric conditions.",
  };
};
...
export const getUvStatus = (uv?: number | null): UvStatus => {
  ...
  if (uv <= 2) {
    return {
      ...
      color: "text-emerald-400",
      bg: "bg-emerald-500/20 border-emerald-500/30",
      advice: "No sun protection required",
    };
  }
  if (uv <= 5) {
    return {
      ...
      color: "text-amber-400",
      bg: "bg-amber-500/20 border-amber-500/30",
      advice: "Wear sunglasses & sun lotion",
    };
  }
  if (uv <= 7) {
    return {
      ...
      color: "text-orange-400",
      bg: "bg-orange-500/20 border-orange-500/30",
      advice: "Seek shade during midday hours",
    };
  }
  if (uv <= 10) {
    return {
      ...
      color: "text-rose-400",
      bg: "bg-rose-500/20 border-rose-500/30",
      advice: "Extra precaution: avoid direct sun",
    };
  }
  return {
    label: "Extreme",
    color: "text-purple-400",
    bg: "bg-purple-500/20 border-purple-500/30",
    advice: "Take all outdoor precautions",
  };
};
